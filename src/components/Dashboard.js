...
import {startGetBills} from '../actions/startGetBills'
                        ...
                        <div className="col-md-8">
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="card">
                                        <div className="card-header text-center"><h3>Total Products</h3></div>
                                        <div className="card-body"><h5 className="card-title text-center">{prodata.length}</h5></div>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="card">
                                        <div className="card-header text-center"><h3>Total Customers</h3></div>
                                        <div className="card-body"><h5 className="card-title text-center">{cxdata.length}</h5></div>
                                    </div>
                                </div>
                                <div className="col-md-6 mt-3">
                                    <div className="card">
                                        <div className="card-header text-center"><h3>Total Bills</h3></div>
                                        <div className="card-body"><h5 className="card-title text-center">{billdata.length}</h5></div>
                                    </div>
                                </div>
                            </div>
                        </div>
